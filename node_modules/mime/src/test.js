...
assert.equal('html', mime.extension(mime.types.html));
assert.equal('css', mime.extension(mime.types.css));
assert.equal('javascript', mime.extension(mime.types.javascript));
...
assert.equal('html', mime.extension('text/html;charset=UTF-8'));
assert.equal('html', mime.extension('text/Html;charset=UTF-8'));
assert.equal('css', mime.extension('text/css; charset=UTF-8'));
assert.equal('javascript', mime.extension('text/javascript; charset=UTF-8'));
